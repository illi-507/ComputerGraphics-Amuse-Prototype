...
this.tube7 = new newTube1("cube7",position,2,[0.0,1.0,0.2]);
		this.tube8 = new newTube2("cube8",position,2,[0.0,1.0,0.2]);
		
		this.boat1 = new Boat("cube1",position,0.5,[0.0,1.0,1.0],0);
		this.boat2 = new BoatBottom("cube2",position,1.0,[1.9,0.3,0.3],0);
		this.boat3 = new BoatBottom("cube2",position,1.0,[0.1,0.1,0.9],0);
